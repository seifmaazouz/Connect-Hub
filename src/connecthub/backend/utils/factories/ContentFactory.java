...
public class ContentFactory {
    ...
    public static Post createPost(String type, String authorId, String text, String imagePath) {
    ...
    public static Story createStory(String type, String authorId, String text, String imagePath) {
        ContentData contentData = new ContentData(text, imagePath);
